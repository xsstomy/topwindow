      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-body text-xl max-w-2xl mx-auto">
            Get started with TopWindow today. Professional window management for macOS.
          </p>
          ...
          {versionInfo && (
            <div className="mt-6 inline-flex items-center gap-2 px-4 py-2 bg-blue-50 border border-blue-200 rounded-lg text-blue-800">
              ...
              <span className="text-sm font-medium">
                Latest Version: {versionInfo.version} • Released {new Date(versionInfo.releaseDate).toLocaleDateString()}
              </span>
            </div>
          )}
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          ...
          >
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-100">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h2 className="text-2xl font-semibold text-gray-900">TopWindow</h2>
                  <p className="text-gray-600">Professional Window Management</p>
                  {versionInfo && (
              ...
              <div className="border-t pt-6">
                <h3 className="font-semibold text-gray-900 mb-4">macOS Download</h3>
          ...
          >
            ...
            {/* Installation Guide */}
            <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
              <h3 className="font-semibold text-gray-900 mb-4">Quick Installation</h3>
              ...
              <div className="space-y-4">
                <div className="flex gap-3">
                  ...
                  <span className="text-sm text-gray-700">Download and open the installer</span>
                </div>
                <div className="flex gap-3">
                  <div className="w-6 h-6 bg-primary text-white rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0">
                    2
                  </div>
                  <span className="text-sm text-gray-700">Follow the installation wizard</span>
                </div>
                <div className="flex gap-3">
                  <div className="w-6 h-6 bg-primary text-white rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0">
                    3
                  </div>
                  <span className="text-sm text-gray-700">Grant accessibility permissions</span>
                </div>
                <div className="flex gap-3">
                  <div className="w-6 h-6 bg-primary text-white rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0">
                    4
                  </div>
                  <span className="text-sm text-gray-700">Start managing your windows!</span>
                </div>
              </div>
        ...
        {error && (
          ...
          >
            ...
            <p className="text-red-800 font-medium mb-2">Unable to load download information</p>
