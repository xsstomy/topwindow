...
import { Monitor, Cpu, HardDrive, CheckCircle, AlertCircle, Info } from 'lucide-react'

export const metadata: Metadata = {
  title: 'System Requirements - TopWindow',
  description: 'TopWindow system requirements for macOS. Check compatibility, hardware requirements, and supported macOS versions.',
}

const macOSVersions = [
  { version: "macOS 15 Sequoia", status: "supported", note: "Latest version - fully supported" },
  { version: "macOS 14 Sonoma", status: "supported", note: "Fully supported" },
  { version: "macOS 13 Ventura", status: "supported", note: "Minimum required version" },
  { version: "macOS 12 Monterey", status: "unsupported", note: "Not supported - please upgrade" },
  { version: "macOS 11 Big Sur", status: "unsupported", note: "Not supported - please upgrade" },
  { version: "macOS 10.15 Catalina", status: "unsupported", note: "Not supported - please upgrade" },
]
...
interface RequirementCardProps {
  ...
  title: string
  items: Array<{ label: string; value: string; status?: 'required' | 'recommended' | 'optimal' }>
}
      ...
      <div className="container-custom section-padding">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-body max-w-2xl mx-auto">
            Check if your Mac is compatible with TopWindow and learn about the hardware requirements for optimal performance.
          </p>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-gradient-to-r from-primary/10 to-blue-50 rounded-xl p-8 mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <h3 className="font-semibold text-gray-900 mb-2">macOS Version</h3>
                <p className="text-gray-600 text-sm">macOS 13.0 (Ventura) or later required</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-primary/20 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <p className="text-gray-600 text-sm">Intel or Apple Silicon Mac</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-primary/20 rounded-full flex items-center justify-center mx-auto mb-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            ...
            <RequirementCard
              ...
              items={[
                { label: "Operating System", value: "macOS 13.0+", status: "required" },
                { label: "Processor", value: "Intel or Apple Silicon", status: "required" },
                { label: "Memory (RAM)", value: "4 GB", status: "required" },
                { label: "Storage", value: "50 MB", status: "required" },
                { label: "Permissions", value: "Accessibility Access", status: "required" },
              ]}
            />
            ...
            <RequirementCard
              ...
              items={[
                { label: "Operating System", value: "macOS 14.0+", status: "recommended" },
                { label: "Processor", value: "Apple Silicon (M1+)", status: "optimal" },
                { label: "Memory (RAM)", value: "8 GB or more", status: "recommended" },
                { label: "Storage", value: "100 MB free", status: "recommended" },
                { label: "Display", value: "Retina Display", status: "optimal" },
              ]}
            />
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
              {macOSVersions.map((version, index) => (
                <div key={index} className={`p-6 flex items-center justify-between ${index !== macOSVersions.length - 1 ? 'border-b border-gray-200' : ''}`}>
                  ...
                  <span className={`px-3 py-1 rounded-full text-sm font-medium ${
                    ...
                    {version.status === 'supported' ? 'Supported' : 'Not Supported'}
                  </span>
                </div>
              ))}
            </div>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-8 mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h3 className="font-semibold text-gray-900 mb-3">Apple Silicon Macs (M1, M2, M3)</h3>
              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-600 text-sm">
                  ...
                  <li>• Slightly higher memory usage compared to Apple Silicon</li>
                  <li>• Works well on models from 2016 onwards</li>
                  <li>• May require more system resources for optimal performance</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-8 mb-12">
            ...
            <p className="text-gray-700 mb-4">
              TopWindow requires the following system permissions to function properly:
            </p>
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                <div>
                  <h3 className="font-semibold text-gray-900">Accessibility Access</h3>
                  <p className="text-gray-600 text-sm">Required to detect active windows and apply always-on-top functionality. Granted in System Preferences → Privacy & Security → Accessibility.</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 p-4 bg-white rounded-lg">
              <p className="text-sm text-gray-700">
                <strong>Privacy Note:</strong> TopWindow only uses these permissions for its core functionality and does not collect, store, or transmit any personal data.
              </p>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-primary/10 to-blue-50 rounded-xl p-8 text-center">
            ...
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              Not sure if your Mac meets the requirements? Our support team can help you determine compatibility and optimize TopWindow for your system.
            </p>
