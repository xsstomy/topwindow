...
export const metadata: Metadata = {
  ...
  description: 'TopWindow release notes and version history. Stay updated with the latest features, bug fixes, and improvements.',
}
...
function ReleaseCard({ release }: ReleaseCardProps) {
  ...
  return (
    <div className={`bg-white border rounded-xl p-8 ${isLatest ? 'border-primary shadow-lg' : 'border-gray-200'}`}>
      {isLatest && (
      ...
      <div className="container-custom section-padding">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-body max-w-2xl mx-auto">
            Stay up to date with the latest TopWindow features, improvements, and bug fixes. 
            We're constantly working to make TopWindow better for you.
          </p>
        </div>
        ...
        <div className="bg-gradient-to-r from-primary/10 to-blue-50 rounded-xl p-8 mb-12 text-center">
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <h2 className="text-xl font-semibold text-gray-900">Current Stable Version</h2>
          </div>
          <p className="text-3xl font-bold text-primary mb-2">v{releases[0].version}</p>
        ...
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-semibold text-gray-900 mb-8">Version History</h2>
          ...
          <div className="mt-16 bg-white border border-gray-200 rounded-xl p-8 text-center">
            ...
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              If you're using TopWindow v1.x, we strongly recommend upgrading to the latest 2.x version 
              for better performance, stability, and new features. The upgrade process is seamless and your 
          ...
          <div className="mt-12 bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-200 rounded-xl p-8">
            ...
            <p className="text-gray-600 mb-6 text-center max-w-2xl mx-auto">
              Want to try new features before they're officially released? Join our beta program 
              to get early access to upcoming features and help shape the future of TopWindow.
            </p>
