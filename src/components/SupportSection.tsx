...
const supportOptions = [
  {
    ...
    description:
      'Browse our comprehensive FAQ section to find quick solutions to common questions.',
    action: 'View FAQ',
    color: 'text-blue-600',
    bgColor: 'bg-blue-50',
  ...
  },
  {
    ...
    title: 'Email Support',
    description:
      'Send an email to our technical support team and we will respond promptly.',
    action: 'Send Email',
    color: 'text-green-600',
    bgColor: 'bg-green-50',
    onClick: () => (window.location.href = 'mailto:xsstomy@gmail.com'),
  },
];
    ...
    <section id='support' className='section-padding bg-gray-50'>
      <div className='container-custom'>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className='heading-md mb-4'>Technical Support</h2>
          <p className='text-body max-w-2xl mx-auto'>
            We're here to help you succeed. Whatever questions you have, you can
            ...
            >
              <div className='bg-white rounded-2xl p-8 shadow-lg border border-gray-100 h-full transition-all duration-300 group-hover:shadow-2xl group-hover:border-primary/20'>
                ...
                <button
                  ...
                  className='w-full btn-secondary text-sm font-medium'
                >
                  {option.action}
                </button>
        ...
        >
          ...
          <p className='text-gray-secondary mb-8 max-w-2xl mx-auto'>
            If you have additional questions or feedback, feel free to contact
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
            <div className='text-center'>
              ...
              <h4 className='font-semibold text-gray-text mb-2'>
                Email Address
              </h4>
