...
export default function PricingSection() {
  ...
  return (
    <section
      id='pricing'
      className='section-padding bg-gradient-to-br from-gray-light to-blue-50 relative overflow-hidden'
    >
      ...
      <div className='container-custom relative'>
        ...
        <div className='text-center max-w-6xl mx-auto'>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className='heading-md mb-6'>Start Your TopWindow Journey</h2>
            <p className='text-xl md:text-2xl text-gray-secondary leading-relaxed max-w-3xl mx-auto'>
              First, experience 7 days of full professional features for free,
              ...
              >
                ...
                <div className='bg-white rounded-3xl p-8 border border-gray-100 shadow-2xl relative'>
                  <div className='text-center mb-6'>
                    <h3 className='text-2xl font-bold text-gray-text mb-2'>
                      7-Day Free Trial
                    </h3>
                    ...
                    <p className='text-gray-secondary'>
                      Full Features • No Limitations • 7-Day Experience
                    </p>
                  </div>
                  ...
                  <div className='space-y-3 mb-8'>
                    ...
                    <div className='mt-4 p-3 bg-blue-50 rounded-lg border border-blue-200'>
                      <p className='text-blue-700 text-sm text-center'>
                        ⏰ Choose to purchase professional version after trial
                        period to continue using
                      </p>
                    </div>
                  </div>
                ...
                <div className='bg-white rounded-3xl p-8 border border-gray-100 shadow-2xl relative'>
                  ...
                  <div className='text-center mb-6 mt-4'>
                    ...
                    <div className='text-4xl font-bold text-primary mb-2'>
                      {formatPrice(TOPWINDOW_LICENSE_PRICE)}
                    </div>
                    <p className='text-gray-secondary'>
          ...
          {viewMode === 'overview' && (
            ...
            >
              <div className='flex flex-col items-center gap-3'>
                ...
                <div>
                  <h4 className='font-semibold text-gray-text mb-1'>
                    7-Day Free Trial
                  </h4>
